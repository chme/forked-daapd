...
db_table_upgrade(sqlite3 *hdl, const char *name, const char *newtablequery)
{
  ...
  CHECK_NULL(
      L_DB, query = sqlite3_mprintf("INSERT INTO new_%s SELECT %s FROM %s;", name, sqlite3_column_text(stmt, 0), name));
...
#define U_V18_PL_TYPE_CHANGE_PLAIN "UPDATE playlists SET type = 3 WHERE type = 0;"
#define U_V18_PL_TYPE_CHANGE_SPECIAL "UPDATE playlists SET type = 0 WHERE type = 2;"
#define U_V18_DROP_VIEW_FILELIST "DROP VIEW IF EXISTS filelist;"
...
#define U_V18_SCVER_MAJOR "UPDATE admin SET value = '18' WHERE key = 'schema_version_major';"
#define U_V18_SCVER_MINOR "UPDATE admin SET value = '00' WHERE key = 'schema_version_minor';"
...
#define U_V1801_UPDATE_PLAYLISTS_M3U "UPDATE playlists SET virtual_path = replace(virtual_path, '.m3u', '');"
#define U_V1801_UPDATE_PLAYLISTS_PLS "UPDATE playlists SET virtual_path = replace(virtual_path, '.pls', '');"
#define U_V1801_UPDATE_PLAYLISTS_SMARTPL "UPDATE playlists SET virtual_path = replace(virtual_path, '.smartpl', '');"

#define U_V1801_SCVER_MAJOR "UPDATE admin SET value = '18' WHERE key = 'schema_version_major';"
#define U_V1801_SCVER_MINOR "UPDATE admin SET value = '01' WHERE key = 'schema_version_minor';"
...
#define U_V1900_DROP_VIEW_FILELIST "DROP VIEW IF EXISTS filelist;"
#define U_V1900_ALTER_PL_ADD_DIRECTORYID "ALTER TABLE playlists ADD COLUMN directory_id INTEGER DEFAULT 0;"
#define U_V1900_ALTER_FILES_ADD_DIRECTORYID "ALTER TABLE files ADD COLUMN directory_id INTEGER DEFAULT 0;"
#define U_V1900_ALTER_FILES_ADD_DATERELEASED "ALTER TABLE files ADD COLUMN date_released INTEGER DEFAULT 0;"
#define U_V1900_ALTER_SPEAKERS_ADD_NAME "ALTER TABLE speakers ADD COLUMN name VARCHAR(255) DEFAULT NULL;"
...
#define U_V1900_SCVER_MAJOR "UPDATE admin SET value = '19' WHERE key = 'schema_version_major';"
#define U_V1900_SCVER_MINOR "UPDATE admin SET value = '00' WHERE key = 'schema_version_minor';"
...
db_upgrade_v19_directory_id(sqlite3 *hdl, char *virtual_path)
{
  ...
  query
      = sqlite3_mprintf("SELECT d.id FROM directories d WHERE d.disabled = 0 AND d.virtual_path = '%q';", virtual_path);
  if (!query)
    {
...
db_upgrade_v19(sqlite3 *hdl)
{
  ...
  query = "SELECT id, virtual_path FROM playlists WHERE type = 2 OR type = 3;"; // Only update normal and smart
                                                                                // playlists
...
#define U_V1901_QUEUE_VERSION "INSERT INTO admin (key, value) VALUES ('queue_version', '0');"

#define U_V1901_SCVER_MAJOR "UPDATE admin SET value = '19' WHERE key = 'schema_version_major';"
#define U_V1901_SCVER_MINOR "UPDATE admin SET value = '01' WHERE key = 'schema_version_minor';"
...
#define U_V1902_CREATE_TABLE_ADMINTMP                                                                                  \
  ...
  ");"
#define U_V1902_INSERT_ADMINTMP "INSERT INTO admin_tmp SELECT * FROM admin;"
#define U_V1902_DROP_TABLE_ADMIN "DROP TABLE admin;"
#define U_V1902_CREATE_TABLE_ADMIN                                                                                     \
  "CREATE TABLE IF NOT EXISTS admin("                                                                                  \
  "   key   VARCHAR(32) PRIMARY KEY NOT NULL,"                                                                         \
  "   value VARCHAR(32) NOT NULL"                                                                                      \
  ");"
#define U_V1902_INSERT_ADMIN "INSERT OR IGNORE INTO admin SELECT * FROM admin_tmp;"
#define U_V1902_DROP_TABLE_ADMINTMP "DROP TABLE admin_tmp;"

#define U_V1902_SCVER_MAJOR "UPDATE admin SET value = '19' WHERE key = 'schema_version_major';"
#define U_V1902_SCVER_MINOR "UPDATE admin SET value = '02' WHERE key = 'schema_version_minor';"
...
#define U_V1903_ALTER_QUEUE_ADD_ARTWORKURL "ALTER TABLE queue ADD COLUMN artwork_url VARCHAR(4096) DEFAULT NULL;"

#define U_V1903_SCVER_MAJOR "UPDATE admin SET value = '19' WHERE key = 'schema_version_major';"
#define U_V1903_SCVER_MINOR "UPDATE admin SET value = '03' WHERE key = 'schema_version_minor';"
...
#define U_V1904_ALTER_SPEAKERS_ADD_AUTHKEY "ALTER TABLE speakers ADD COLUMN auth_key VARCHAR(2048) DEFAULT NULL;"

#define U_V1904_SCVER_MAJOR "UPDATE admin SET value = '19' WHERE key = 'schema_version_major';"
#define U_V1904_SCVER_MINOR "UPDATE admin SET value = '04' WHERE key = 'schema_version_minor';"
...
#define U_V1905_SCVER_MINOR "UPDATE admin SET value = '05' WHERE key = 'schema_version_minor';"
...
#define U_V1906_DROP_TABLE_QUEUE "DROP TABLE queue;"
...
#define U_V1906_UPDATE_HTTP_VIRTUAL_PATH "UPDATE files SET virtual_path = '/' || path WHERE data_kind = 1;"

#define U_V1906_SCVER_MAJOR "UPDATE admin SET value = '19' WHERE key = 'schema_version_major';"
#define U_V1906_SCVER_MINOR "UPDATE admin SET value = '06' WHERE key = 'schema_version_minor';"
...
#define U_V1907_SCVER_MINOR "UPDATE admin SET value = '07' WHERE key = 'schema_version_minor';"
...
#define U_V1908_ALTER_PL_ADD_ORDER "ALTER TABLE playlists ADD COLUMN query_order VARCHAR(1024);"
#define U_V1908_ALTER_PL_ADD_LIMIT "ALTER TABLE playlists ADD COLUMN query_limit INTEGER DEFAULT -1;"

#define U_V1908_SCVER_MINOR "UPDATE admin SET value = '08' WHERE key = 'schema_version_minor';"
...
#define U_V1909_ALTER_FILES_ADD_SKIP_COUNT "ALTER TABLE files ADD COLUMN skip_count INTEGER DEFAULT 0;"
#define U_V1909_ALTER_FILES_ADD_TIME_SKIPPED "ALTER TABLE files ADD COLUMN time_skipped INTEGER DEFAULT 0;"

#define U_V1909_SCVER_MINOR "UPDATE admin SET value = '09' WHERE key = 'schema_version_minor';"
...
#define U_V1910_CLEANUP_TIME_SKIPPED "UPDATE files SET time_skipped = 0 WHERE time_skipped > 2000000000;"

#define U_V1910_SCVER_MINOR "UPDATE admin SET value = '10' WHERE key = 'schema_version_minor';"
...
#define U_v1911_ALTER_QUEUE_ADD_COMPOSER "ALTER TABLE queue ADD COLUMN composer VARCHAR(1024) DEFAULT NULL;"

#define U_v1911_SCVER_MAJOR "UPDATE admin SET value = '19' WHERE key = 'schema_version_major';"
#define U_v1911_SCVER_MINOR "UPDATE admin SET value = '11' WHERE key = 'schema_version_minor';"
...
#define U_V1912_ALTER_DIRECTORIES_ADD_PATH "ALTER TABLE directories ADD COLUMN path VARCHAR(4096) DEFAULT NULL;"

#define U_V1912_UPDATE_FILE_DIRECTORIES_PATH                                                                           \
  "UPDATE directories SET path = SUBSTR(path, 7) WHERE virtual_path like '/file:/%';"
#define U_V1912_UPDATE_FILE_ROOT_PATH "UPDATE directories SET path = '/' WHERE virtual_path = '/file:';"

#define U_V1912_SCVER_MINOR "UPDATE admin SET value = '12' WHERE key = 'schema_version_minor';"
...
#define U_V2000_DROP_TRG1 "DROP TRIGGER IF EXISTS update_groups_new_file;"
#define U_V2000_DROP_TRG2 "DROP TRIGGER IF EXISTS update_groups_update_file;"

#define U_V2000_SCVER_MAJOR "UPDATE admin SET value = '20' WHERE key = 'schema_version_major';"
#define U_V2000_SCVER_MINOR "UPDATE admin SET value = '00' WHERE key = 'schema_version_minor';"
...
#define U_V2001_ALTER_QUEUE_ADD_SONGARTISTID "ALTER TABLE queue ADD COLUMN songartistid INTEGER NOT NULL default 0;"
#define U_V2001_SCVER_MINOR "UPDATE admin SET value = '01' WHERE key = 'schema_version_minor';"
...
#define U_V2100_SCVER_MAJOR "UPDATE admin SET value = '21' WHERE key = 'schema_version_major';"
#define U_V2100_SCVER_MINOR "UPDATE admin SET value = '00' WHERE key = 'schema_version_minor';"
...
#define U_v2101_ALTER_QUEUE_ADD_TYPE "ALTER TABLE queue ADD COLUMN type VARCHAR(8) DEFAULT NULL;"
#define U_v2101_ALTER_QUEUE_ADD_BITRATE "ALTER TABLE queue ADD COLUMN bitrate INTEGER DEFAULT 0;"
#define U_v2101_ALTER_QUEUE_ADD_SAMPLERATE "ALTER TABLE queue ADD COLUMN samplerate INTEGER DEFAULT 0;"
#define U_v2101_ALTER_QUEUE_ADD_CHANNELS "ALTER TABLE queue ADD COLUMN channels INTEGER DEFAULT 0;"
#define U_v2101_ALTER_FILES_ADD_CHANNELS "ALTER TABLE files ADD COLUMN channels INTEGER DEFAULT 0;"

#define U_v2101_SCVER_MINOR "UPDATE admin SET value = '01' WHERE key = 'schema_version_minor';"
...
#define U_v2102_ALTER_PLAYLISTS_ADD_MEDIA_KIND "ALTER TABLE playlists ADD COLUMN media_kind INTEGER DEFAULT 1;"

#define U_v2102_SCVER_MINOR "UPDATE admin SET value = '02' WHERE key = 'schema_version_minor';"
...
#define U_V2103_SCVER_MAJOR "UPDATE admin SET value = '21' WHERE key = 'schema_version_major';"
#define U_V2103_SCVER_MINOR "UPDATE admin SET value = '03' WHERE key = 'schema_version_minor';"
...
#define U_v2104_SCVER_MINOR "UPDATE admin SET value = '04' WHERE key = 'schema_version_minor';"
...
#define U_v2105_UPDATE_SPEAKERS_AUTH_KEY                                                                               \
  "UPDATE speakers SET auth_key = SUBSTR(auth_key, LENGTH(auth_key) - 128 + 1, LENGTH(auth_key) + 1) WHERE "           \
  "LENGTH(auth_key) = 128 + 64;"
#define U_v2105_SCVER_MINOR "UPDATE admin SET value = '05' WHERE key = 'schema_version_minor';"
...
#define U_v2106_SCVER_MINOR "UPDATE admin SET value = '06' WHERE key = 'schema_version_minor';"
...
/* ---------------------------- 21.06 -> 21.07 ------------------------------ */
#define U_v2107_ALTER_FILES_USERMARK "ALTER TABLE files ADD COLUMN usermark INTEGER DEFAULT 0;"
#define U_v2107_SCVER_MINOR "UPDATE admin SET value = '07' WHERE key = 'schema_version_minor';"
...
#define U_v2200_ALTER_FILES_ADD_SCAN_KIND "ALTER TABLE files ADD COLUMN scan_kind INTEGER DEFAULT 0;"
#define U_v2200_ALTER_PLAYLISTS_ADD_SCAN_KIND "ALTER TABLE playlists ADD COLUMN scan_kind INTEGER DEFAULT 0;"
#define U_v2200_ALTER_DIR_ADD_SCAN_KIND "ALTER TABLE directories ADD COLUMN scan_kind INTEGER DEFAULT 0;"
...
#define U_v2200_FILES_SET_SCAN_KIND_SPOTIFY "UPDATE files SET scan_kind = 2 WHERE virtual_path like '/spotify:/%';"
#define U_v2200_FILES_SET_SOURCE_FILE_SCANNER "UPDATE files SET scan_kind = 1 WHERE scan_kind = 0;"

#define U_v2200_PL_SET_SCAN_KIND_RSS "UPDATE playlists SET scan_kind = 3 WHERE type = 4;" // PL_RSS  = 4
#define U_v2200_PL_SET_SCAN_KIND_SPOTIFY "UPDATE playlists SET scan_kind = 2 WHERE virtual_path like '/spotify:/%';"
#define U_v2200_PL_SET_SCAN_KIND_FILES "UPDATE playlists SET scan_kind = 1 WHERE scan_kind = 0;"

// Note: RSS feed items do not have their own directory structure (they use "http:/")
#define U_v2200_DIR_SET_SCAN_KIND_SPOTIFY "UPDATE directories SET scan_kind = 2 WHERE virtual_path like '/spotify:/%';"
#define U_v2200_DIR_SET_SCAN_KIND_FILES "UPDATE directories SET scan_kind = 1 WHERE virtual_path like '/file:/%';"

#define U_v2200_SCVER_MAJOR "UPDATE admin SET value = '22' WHERE key = 'schema_version_major';"
#define U_v2200_SCVER_MINOR "UPDATE admin SET value = '00' WHERE key = 'schema_version_minor';"
...
#define U_v2201_ALTER_FILES_ADD_LYRICS "ALTER TABLE files ADD COLUMN lyrics TEXT DEFAULT NULL COLLATE DAAP;"

#define U_v2201_SCVER_MAJOR "UPDATE admin SET value = '22' WHERE key = 'schema_version_major';"
#define U_v2201_SCVER_MINOR "UPDATE admin SET value = '01' WHERE key = 'schema_version_minor';"
...
#define U_v2202_ALTER_SPEAKERS_ADD_FORMAT "ALTER TABLE speakers ADD COLUMN format INTEGER DEFAULT 0;"

#define U_v2202_SCVER_MAJOR "UPDATE admin SET value = '22' WHERE key = 'schema_version_major';"
#define U_v2202_SCVER_MINOR "UPDATE admin SET value = '02' WHERE key = 'schema_version_minor';"
