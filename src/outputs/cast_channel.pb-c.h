...
typedef enum _Extensions__CoreApi__CastChannel__CastMessage__PayloadType {
  ...
  EXTENSIONS__CORE_API__CAST_CHANNEL__CAST_MESSAGE__PAYLOAD_TYPE__BINARY
  = 1 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(EXTENSIONS__CORE_API__CAST_CHANNEL__CAST_MESSAGE__PAYLOAD_TYPE)
...
typedef enum _Extensions__CoreApi__CastChannel__AuthError__ErrorType {
  ...
  EXTENSIONS__CORE_API__CAST_CHANNEL__AUTH_ERROR__ERROR_TYPE__SIGNATURE_ALGORITHM_UNAVAILABLE
  = 2 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(EXTENSIONS__CORE_API__CAST_CHANNEL__AUTH_ERROR__ERROR_TYPE)
...
typedef enum _Extensions__CoreApi__CastChannel__SignatureAlgorithm {
  ...
  EXTENSIONS__CORE_API__CAST_CHANNEL__SIGNATURE_ALGORITHM__RSASSA_PSS
  = 2 PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(EXTENSIONS__CORE_API__CAST_CHANNEL__SIGNATURE_ALGORITHM)
...
typedef void (*Extensions__CoreApi__CastChannel__CastMessage_Closure)(
    const Extensions__CoreApi__CastChannel__CastMessage *message, void *closure_data);
typedef void (*Extensions__CoreApi__CastChannel__AuthChallenge_Closure)(
    const Extensions__CoreApi__CastChannel__AuthChallenge *message, void *closure_data);
typedef void (*Extensions__CoreApi__CastChannel__AuthResponse_Closure)(
    const Extensions__CoreApi__CastChannel__AuthResponse *message, void *closure_data);
typedef void (*Extensions__CoreApi__CastChannel__AuthError_Closure)(
    const Extensions__CoreApi__CastChannel__AuthError *message, void *closure_data);
typedef void (*Extensions__CoreApi__CastChannel__DeviceAuthMessage_Closure)(
    const Extensions__CoreApi__CastChannel__DeviceAuthMessage *message, void *closure_data);
